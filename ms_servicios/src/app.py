...
from routes.servicios_routes import servicios
...
app = FastAPI(
    title="Servicio de servicios",
    description="API de gestión para los servicios en ReservaT",
    debug=True,
    root_path="/api/v1",
    docs_url="/servicios/docs",
    openapi_url="/servicios/openapi.json"
)
