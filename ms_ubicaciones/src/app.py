...
app = FastAPI(
    title="Servicio de Ubicaciones",
    description="Catálogo de países, departamentos y municipios de ReservaT",
    debug=os.getenv("DEBUG", "false").lower() == "true",
    root_path="/api/v1",
    docs_url="/ubicaciones/docs",
    openapi_url="/ubicaciones/openapi.json"
)
...
# Incluir el router del catálogo de ubicaciones
app.include_router(ubicaciones, prefix="", tags=["Ubicaciones"])
