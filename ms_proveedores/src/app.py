...
from routes.proveedores_routes import proveedores
...
app = FastAPI(
    title="Servicio de proveedores",
    description="API de gestión para los proveedores en ReservaT",
    debug=os.getenv("DEBUG", "false").lower() == "true",
    root_path="/api/v1",
    docs_url="/proveedores/docs",
    openapi_url="/proveedores/openapi.json"
)
...
# Configurar CORS como el middleware más externo
app.add_middleware(
    CORSMiddleware,
...
# Incluir el router de proveedores
app.include_router(proveedores, prefix="", tags=["Proveedores"])
